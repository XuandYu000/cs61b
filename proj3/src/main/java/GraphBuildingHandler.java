...
//            System.out.println("Beginning a way...");
            ...
            if (k.equals("maxspeed")) {
                ...
                String sep = GraphDB.cleanString(v);
                way.setMaxspeed(Integer.parseInt(sep));
...
//            System.out.println("Node's name: " + attributes.getValue("v"));
            lastNode.setLocation(attributes.getValue("name"));
        }
    }
...
//            System.out.println("Finishing a way...");
            if (way.getValid()) {
                for (int i = 0 ; i < connections.size() - 1; i++) {
                    Node node = g.getNode(connections.get(i));
                    node.connect(connections.get(i + 1));
                    g.getNode(connections.get(i + 1)).connect(node.getId());
                }
                g.addEdge(way);
            }
            connections.clear();
