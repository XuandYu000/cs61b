...
public class Plip extends Creature {
    ...
    private static final double energyLimit = 2.0;
     ...
     */
    public Color color() {
        g = (int) (63 + (255 - 63) / energyLimit * energy);
        return color(r, g, b);
    }
    ...
    public void stay() {
        energy = energy + stayEnergyGained >= energyLimit ? energyLimit : energy + stayEnergyGained;
    }
